                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" align="left">
                                                        <?php echo "<form action='../proses/IListPengeluaran?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                    ...
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size: clamp(12px, 1vw, 12px); color: black;">Jenis Pengeluaran</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                ...
                                                <td style='font-size: clamp(12px, 1vw, 12px); color: black;' >$jenis_pengeluaran</td>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <select name="jenis_pengeluaran" class="form-control">
                                                                                    <?php $dataSelect = $data['jenis_pengeluaran']; ?>
