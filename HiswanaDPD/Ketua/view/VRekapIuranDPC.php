        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Posisi Halaman -->
                    <small class="m-0 font-weight-thin text-primary"><a href="DsKetua">Dashboard</a> <i style="color: grey;" class="fa fa-caret-right" aria-hidden="true"></i> <a style="color: grey;">Rekap Iuran DPC</a> </small>
                    <br>
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h5 style="color: grey;">Rekap Iuran DPC</h5>
                        </div>
                        <!-- Card Body -->
                        <div style="height: 700px;" class="card-body">
                            <div class="chart-area">
                                ...
                                <?php echo "<form  method='POST' action='VRekapIuranDPC' style='margin-bottom: 15px;'>" ?>
                                <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <?php echo "<a href='VCetakIuranDPC?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:white;
                                             '  type='submit' class=' btn btn-secondary' >  <i class='fa-solid fa-print'></i> Cetak Rekap Iuran DPC</button></a>"; ?>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <table align="center" id="example" class="table-sm table-striped table-bordered  nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($table)) {
                                                ...
                                                <td style='font-size: clamp(12px, 1vw, 15px); color: black;' >"; ?> <?= formatuang($total_iuran); ?> <?php echo "</td>
                                                </tr>";
                                            }
                                                ?>
